...
const isModuleName = /^~([^/]+|[^/]+\/|@[^/]+[/][^/]+|@[^/]+\/?|@[^/]+[/][^/]+\/)$/; // `[drive_letter]:\` + `\\[server]\[sharename]\`
...
function createWebpackLessPlugin(loaderContext) {
  ...
  class WebpackFileManager extends _less.default.FileManager {
    ...
    async resolveFilename(filename, currentDirectory, options) {
      ...
      const request = (0, _loaderUtils.urlToRequest)(url, url.charAt(0) === '/' ? loaderContext.rootContext : null); // Less is giving us trailing slashes, but the context should have no trailing slash
